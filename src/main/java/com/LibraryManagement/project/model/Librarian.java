...
public class Librarian {
	...
	//(regexp="(?=.?[A-Z])(?=.?[a-z])(?=.?[0-9])(?=.?[#?!@$%^&*-]).{8,}$",message="*must have:atleast 1Upper,1Lower,1SpecialChar,1digit")
	@Size(min=8,message="*password size must be atleast 8")
	private String librarianPassword;
	@NotBlank(message="*this field is required")
	private String librarianGender;
	@Size(min=5,message= "*must contain atleast 5 chars")
...
// getters and setters for librarianFields
	...
	public String getLibrarianContact() {
		return librarianContact;
	}
	public void setLibrarianContact(String librarianContact) {
