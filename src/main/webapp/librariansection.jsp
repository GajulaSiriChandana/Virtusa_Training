    ...
    <div class="wrapper">
		...
		<section>
			...
			<div class="content"><br><br><br><br><br><br><br><br><br><br>
				...
				<div>
					<a href="addbooks"> <button type="button"><span></span>ADD BOOK</button></a><br>
                   	<a href="viewbooks"><button type="button"><span></span>VIEW BOOKS</button></a><br>
                   	<a href="deletebook"><button type="button"><span></span>DELETE BOOKS</button></a><br>
                   	<a href="issuebook"> <button type="button"><span></span>ISSUE BOOK</button></a><br>
                   	<a href="viewissuedbooks"> <button type="button"><span></span>VIEW ISSUED BOOK</button></a><br>
                   	<a href="returnBook"> <button type="button"><span></span>RETURN BOOK</button></a><br>
                   	<a href="libLogout"> <button type="button"><span></span>LOG OUT</button></a><br>
				</div>
			</div>
		</section>
	</div>
